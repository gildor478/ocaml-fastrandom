(* OASIS_START *)
(* DO NOT EDIT (digest: e38b86c5a3685841c8e750ff7e248b8c) *)
              ...
              [
                 Library
                   ({
                       ...
                       },
                     {
                        ...
                        bs_c_sources = ["FastRandom_stub.c"];
                        bs_data_files = [];
                        },
                     {
                 ...
                 Executable
                   ({
                        ...
                        bs_build_depends =
                          [
                             FindlibPackage
                               ("benchmark",
                                 Some
                                   (VGreaterEqual (VInt (0, VInt (9, VEnd)))));
                     ...
                     {exec_custom = false; exec_main_is = "BenchSkip.ml"; });
                 Test
