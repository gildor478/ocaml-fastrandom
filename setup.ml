(* OASIS_START *)
(* DO NOT EDIT (digest: a9f53ac02653af4d82a9a501731359c8) *)
(*
       ...
       [
          ...
          ("benchskip",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$bench_skip", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 })
       ];
     ...
     package =
       {
          ...
          sections =
            [
               Library
                 ({cs_name = "fastrandom"; cs_data = PropList.Data.create (); 
                  },
                   {
               ...
               Executable
                 ({cs_name = "BenchSkip"; cs_data = PropList.Data.create (); 
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
